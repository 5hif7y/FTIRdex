...
OUTPUT_IMAGE = "images/resultado_galeria_rGO.png"
...
def main():
    ...
    for i, cfg in enumerate(gallery_configs):
        ...
        # Preprocess using library pipeline function
        z, y_corrected = preprocess_spectrum(x, y, smooth_label, base_label, space='transmittance')
