...
def load_data(filepath, format_type=None):
    ...
    Can manually select format ('FTIR' or 'SERS'), or auto-detect by file extension:
    - If format_type is 'SERS' or .csv extension: Loaded as SERS Raman cell spectrum.
    - If format_type is 'FTIR' or other extensions: Loaded as FTIR transmittance.
    
    Args:
        filepath (str): Path to the data file.
        format_type (str, optional): 'FTIR' or 'SERS'.
    ...
    if format_type is not None:
        ...
        if format_type == "SERS":
            ...
            raise ValueError(f"Unknown format_type: {format_type}. Must be 'FTIR' or 'SERS'.")
    else:
        import warnings
        warnings.warn(
            ...
            "to explicitly specify format_type ('FTIR' or 'SERS') to reduce errors.",
            UserWarning
        )
